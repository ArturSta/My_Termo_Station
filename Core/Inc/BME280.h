...
#define BME280_ADDRESS              0xEC //BME280 I2C ADDRES (0x76<<1) SDO LOW - 0x76, HIGH 0x77
#define BME280_REG_ID               0xD0 //BME280 ID REGISTER
#define BME280_ID                   0x60 //BME280 I2C ID   !!!In BMP different value
...
#define BME280_REG_CTRL_MEAS        0xF4 // Control register pressure and temperature
...
#define BME280_STBY_2000            0xC0
#define BME280_STBY_4000            0xE0
